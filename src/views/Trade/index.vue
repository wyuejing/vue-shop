  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="item in addressInfo" :key="item.id">
        <span class="username" :class="item.isDefault === '1' ? 'selected' : ''">{{
          item.consignee
        }}</span>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至：
        <span>{{ afterAddressDefault.userAddress }}</span
        >&nbsp;&nbsp;收货人：<span>{{ afterAddressDefault.consignee }}</span
        >&nbsp;&nbsp;电话：
        <span>{{ afterAddressDefault.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  computed: {
    afterAddressDefault() {
      if (this.addressInfo.length === 0) return {}
