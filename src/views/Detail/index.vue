      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd
                  ...
                  :key="value.id"
                  @click="setCheck(value, spuSaleAttr.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="stuNum" @change="setStuNum" />
                <a href="javascript:" class="plus" @click="stuNum++">+</a>
                <a href="javascript:" class="mins" @click="stuNum > 1 ? stuNum-- : (stuNum = 1)"
                  >-</a
                >
              </div>
              <div class="add">
